...
% Contenu principal
Voici un cours court en LaTeX sur la multiplication de fractions :



\section*{Multiplication de fractions}

\subsection*{Définition}
La multiplication de deux fractions consiste à multiplier les numérateurs entre eux et les dénominateurs entre eux. Ainsi, pour multiplier les fractions $\frac{a}{b}$ et $\frac{c}{d}$, on obtient $\frac{a \times c}{b \times d}$.

\subsection*{Exemple}
Soit à multiplier $\frac{2}{3}$ et $\frac{5}{7}$. En appliquant la définition, on a :
\[
\frac{2}{3} \times \frac{5}{7} = \frac{2 \times 5}{3 \times 7} = \frac{10}{21}
\]

\subsection*{Propriété essentielle}
La multiplication de fractions est commutative, c'est-à-dire que l'ordre des facteurs n'a pas d'importance. Ainsi, $\frac{a}{b} \times \frac{c}{d} = \frac{c}{d} \times \frac{a}{b}$.
